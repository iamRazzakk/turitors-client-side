            ...
            <div className=" lg:flex text-slate-900 p-10  mx-auto">
                <div className="flex-1">
                    ...
                    <div className="flex gap-4 mt-10">
                        <Link to='addCourse'>
                            <button className="px-6 py-2 md:px-10 md:py-4 bg-[#3d90e9] text-white rounded-full button">Assignment</button>
                        </Link>
                        <Link to='/createAssainment'>
                            <button className="px-6 py-2 md:px-10 md:py-4 button2 btn-outline border text-[#3d90e9] rounded-full">Create</button>
                        </Link>
                    </div>
                </div>
