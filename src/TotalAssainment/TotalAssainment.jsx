        ...
        <div>
            ...
            <div className="">
                ...
                <div className="flex justify-center space-x-4 mt-4">
                    <button className="btn btn-outline btn-primary" onClick={() => setDifficulty("Easy")}>
                        Easy
                    </button>
                    <button className="btn btn-outline btn-primary" onClick={() => setDifficulty("Medium")}>
                        Medium
                    </button>
                    <button className="btn btn-outline btn-primary" onClick={() => setDifficulty("Hard")}>
                        Hard
                    </button>
                </div>
                                            ...
                                            <div className="p-5 h-20">
                                                ...
                                                <div className="md:mr-6">
                                                    <Link to={`/assignmentDetail/${assignment._id}`}>
                                                        <button
                                                            onClick={() => handleAssingmentSelection(assignment)}
                ...
                <nav className="flex items-center justify-center pt-20">
                    {[...Array(Math.ceil(filteredAssignments?.length / itemsPerPage)).keys()].map((page) => (
                        <button
                            key={page}
                            type="button"
